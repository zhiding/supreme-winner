...
def prepare_train(cfg):
    ...
    filepath = cfg['dataset'] + '_' + cfg['method'] \
             + '_23_09_{epoch:02d}_{val_acc:.4f}.h5' 
...
if __name__ == '__main__':
    ...
    train(cfg) 
"""
# training by bottleneck features
model.load_weights('./paris6k_vgg16_weights_07_0.57.h5')

bottleneck_frozen = layer_name.index('flatten')
for layer in model.layers[:bottleneck_frozen]:
    layer.trainable = False

filepath = 'paris6k_vgg16_bottle_weights_{epoch:02d}_{val_acc:.2f}.h5'
